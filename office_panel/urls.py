...
urlpatterns = [
    ...
    path('medical_history/<int:pk>/', medical_history_view.MedicalHistoryDetailView.as_view(),
    ...
    path('medical_history/<int:pk>/update', medical_history_view.MedicalHistoryUpdateView.as_view(),
